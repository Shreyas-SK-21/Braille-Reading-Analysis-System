...
%~\ref{eq:consistency}).
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.95\columnwidth]{regression_bar.pdf}
    \vspace{-2mm}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.85\columnwidth]{tot_heatmap.pdf}
    \vspace{-2mm}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.85\columnwidth]{diff_heatmap.pdf}
    \vspace{-2mm}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.85\columnwidth]{skip_heatmap.pdf}
    \vspace{-2mm}
