...
%~\ref{eq:consistency}).
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.65\columnwidth]{tot_heatmap.pdf}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.65\columnwidth]{diff_heatmap.pdf}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.65\columnwidth]{skip_heatmap.pdf}
