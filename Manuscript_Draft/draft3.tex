...
\setlength{\belowcaptionskip}{-2pt}
    ...
    \begin{itemize}
        ...
        \item 
        A comprehensive multi-metric analysis quantifying seven performance metrics (WPM, velocity IQR, regression/hesitation rate, time-on-task, skip rate, path efficiency, and composite difficulty) implemented via eight concurrent tracker objects.
...
%~\ref{eq:consistency}).
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.60\columnwidth]{regression_bar.pdf}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.60\columnwidth]{tot_heatmap.pdf}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.60\columnwidth]{diff_heatmap.pdf}
    ...
    \begin{figure}[!htp]
    \centering
    \includegraphics[width=0.60\columnwidth]{skip_heatmap.pdf}
